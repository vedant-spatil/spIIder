function captureInteractiveElements(options = {}) {
  ...
  // --- Element Collection ---
  // The tree walker is configured to accept only nodes that are interactive and whose type is 'button' or 'icon-button'.
...
(function() {
  try {
    const runDetection = () => {
      console.clear();
      console.log('Starting intelligent element detection (buttons only)...');
